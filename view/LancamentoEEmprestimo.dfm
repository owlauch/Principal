object LancamentoEmprestimo: TLancamentoEmprestimo
  ...
  object GridPricipal: TGridPanel
    ...
    object PanelSeleção: TPanel
      ...
      AutoSize = True
      TabOrder = 1
      object GridPanelSlcGeral: TGridPanel
        Left = 1
        Top = 1
        Width = 452
        Height = 396
        ...
        ControlCollection = <
          item
            Column = 0
            Control = GroupBoxSeleção
            Row = 0
          end
          item
            Column = 0
            Control = GridPanelBotoes
            Row = 1
          end>
        RowCollection = <
          item
        ...
        object GroupBoxSeleção: TGroupBox
          ...
          TabOrder = 0
          object GridPanelSelecao: TGridPanel
            AlignWithMargins = True
            Left = 5
            Top = 18
            Width = 440
  ...
  object DBGridIDMax: TDBGrid
    Left = 167
    Top = 354
    Width = 82
    Height = 48
    Align = alCustom
    DataSource = DM.DSMaxitem
    TabOrder = 1
    TitleFont.Charset = DEFAULT_CHARSET
    TitleFont.Color = clWindowText
    TitleFont.Height = -11
