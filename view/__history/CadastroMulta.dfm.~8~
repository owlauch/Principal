      ...
      object GridPrincipalcadastro: TGridPanel
        ...
        object PanelMenu: TPanel
          ...
          object GridPanel1: TGridPanel
            ...
            ColumnCollection = <
              item
                Value = 19.999916877579140000
              end
              item
                Value = 20.000403848882320000
              end
              item
                Value = 20.000123486309810000
              end
              item
                Value = 19.999813658126050000
              end
              item
                Value = 19.999742129102680000
              end>
            ControlCollection = <
              item
                Column = 1
